<script>
    ...
    let items = $state([]);
    let form = $state({ id: null, name: "", description: "" });
    ...
    async function saveItem() {
        ...
        try {
            ...
            if (data.success) {
                ...
                errorMessage = data.error || "Failed to save category.";
            }
        } catch (e) {
            console.error(e);
...
<div class="p-6 max-w-6xl mx-auto space-y-6">
    ...
    <Card>
        ...
        {:else if items.length === 0}
            <div class="py-12 text-center">
                <p class="text-neutral-500 font-medium">No categories found.</p>
            </div>
        {:else}
                    ...
                    <tbody class="divide-y divide-neutral-100">
                        {#each items as item (item.id)}
                            ...
                            >
                                ...
                                >
                                <td
                                    class="px-6 py-4 text-sm text-neutral-500 truncate max-w-xs"
                                    >{item.description || "-"}</td
                                >
                                <td
